...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("path_hash_dir", sa.String(length=75), nullable=False),
        sa.Column("path_hash_file", sa.String(length=32), nullable=False),
        sa.Column("image_unique_id", sa.String(length=64), nullable=True),
        sa.Column("file_hash", sa.String(length=32), nullable=False),
        sa.Column("pixel_hash", sa.String(length=32), nullable=True),
        ...
        sa.UniqueConstraint("pixel_hash"),
        sa.UniqueConstraint("perceptual_hash"),
    )
